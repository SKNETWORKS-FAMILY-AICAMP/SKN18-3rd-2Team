...
def search_side_effect(user_query: str) -> str:
    """
    사용자의 증상을 바탕으로, 어떤 약에서 나타난 부작용인지 제시합니다.
    """
...
if __name__ == "__main__":
    ...
    query = "지금 구역질이 나오는데, 어느 약의 부작용인지 알려줘."
    
    print("\n--- 'side_effect_agent' 단독 테스트 ---")
    retrieved_context = search_side_effect(query)
